...
class Energy:
    ...
    electronic: npt.NDArray[np.float64] | None = Data[npt.NDArray[np.float64]](
        dtype=np.float64,
        meta=Metadata(
    ...
    **UUID:** `9e4bdf45-0150-4605-9528-e23aed0be9f2`
    ...
    potential_mm: npt.NDArray[np.float64] | None = Data[npt.NDArray[np.float64]](
        dtype=np.float64,
        meta=Metadata(
    ...
    **UUID:** `399ff4fb-1b3d-41a4-a87a-8143c1646b28`
    ...
    kinetic: npt.NDArray[np.float64] | None = Data[npt.NDArray[np.float64]](
        dtype=np.float64,
        meta=Metadata(
